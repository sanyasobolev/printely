//предлагает пользователю комбинированый select_tag
...
function inittextfield(ctrl) {
	...
	selectWidth = ctrl.offsetWidth;  //ширина с рамкой и паддингами
	...
	textfield.value = "Введите или выберите";
