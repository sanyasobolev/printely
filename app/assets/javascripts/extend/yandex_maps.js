				    ...
				    //фрматирование хинта
				      ...
				      // Кэч
					    var myPolygon_1 = new ymaps.Polygon([
					        ...
					        // Содержимое балуна.
					        //hintContent: "КЭЧ, доставка 35 руб.",
					        zone: '1',
					        description: 'КЭЧ',
					        price: '35'
					    }, {
				      ...
				      // Тарасково
					    var myPolygon_2 = new ymaps.Polygon([
					        ...
					        // Описываем свойства геообъекта.
					        // Содержимое балуна.
					        //hintContent: "Тарасково, НИИ Радио, доставка 60 руб."
					        zone: '2',
				      ...
				      // Кобяково
					    var myPolygon_3 = new ymaps.Polygon([
					        ...
					        // Описываем свойства геообъекта.
					        // Содержимое балуна.
					        //hintContent: "Кобяково, доставка 85 руб."
					        zone: '3',
					    ...
					    var myPolygon_3_5 = new ymaps.Polygon([
					        ...
					        // Описываем свойства геообъекта.
					        // Содержимое балуна.
					        //hintContent: "Краснознаменск, доставка 240 руб."
					        zone: '5',
				      ...
				      // Голицыно
					    var myPolygon_4 = new ymaps.Polygon([
					        ...
					        // Описываем свойства геообъекта.
					        // Содержимое балуна.
					        //hintContent: "Голицыно, доставка 120 руб."
					        zone: '4',
				      ...
				      // Бурцево
					    var myPolygon_5 = new ymaps.Polygon([
					        ...
					        // Описываем свойства геообъекта.
					        // Содержимое балуна.
					        //hintContent: "Бурцево, Петровское, доставка 60 руб."
					        zone: '2',
				      ...
				      // Селятино
					    var myPolygon_6 = new ymaps.Polygon([
					        ...
					        // Описываем свойства геообъекта.
					        // Содержимое балуна.
					        //hintContent: "Селятино, Фабричная, доставка 85 руб."
					        zone: '3',
				      ...
				      // рассудово
					    var myPolygon_7 = new ymaps.Polygon([
					        ...
					        // Описываем свойства геообъекта.
					        // Содержимое балуна.
					        //hintContent: "Зверево, СНТ Весна, доставка 120 руб.",
					        zone: '4',
